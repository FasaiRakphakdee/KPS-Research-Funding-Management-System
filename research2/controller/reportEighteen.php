...
if ($upload != '') {
    ...
    if ($typefile == '.pdf') {
        ...
        $newname = 'doc_' . $form["userId"] . "_reportEighteen_" . $date1 . $typefile;
...
$form["reportEighteenName"] = $doc_name;
$form["reportEighteenDate"] = $currentDate;
$form["state"] = 22; //แก้ตาม flow
$form["statusAll"] = "ส่งรายงานความคืบหน้า 18 เดือน";

$count = $form["count"];

$form["status" . $count] = "ส่งรายงานความคืบหน้า 18 เดือน";
