...
if ($upload != '') {
    ...
    if ($typefile == '.pdf') {
        ...
        $newname = 'doc_' . $form["userId"] . "_reportTwelveMonth_" . $date1 . $typefile;
...
$form["reportTwelveName"] = $doc_name;
$form["reportTwelveDate"] = $currentDate;
$form["state"] = 17; //แก้
$form["statusAll"] = "ส่งรายงานความคืบหน้า 12 เดือน";

$count = $form["count"];

$form["status" . $count] = "ส่งรายงานความคืบหน้า 12 เดือน";
