  ...
  <?php
    ...
    foreach($files as $file){
      ...
      if(strcmp($key, $keyName)===0){
        $name  = $committee[$key]["fullName"];
        $rolecommittee =  $committee[$key]["role"];
        $emailcommittee= $committee[$key]["email"];
      }
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="form-validation">
                <form class="form-valide" action="../controller/editCommittee.php" method="POST"
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-7">
                      <input type="text" class="form-control" id="role" name="role"
                        value="<?php echo $rolecommittee ?>" disabled />
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="col-lg-8 ml-auto">
                    ...
                    <a href="./listcommittee.php" type="submit" class="btn btn-light" style="color: black;">กลับ</a>
                  </div>
                </div>
