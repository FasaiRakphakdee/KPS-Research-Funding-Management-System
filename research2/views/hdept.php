    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">คำขอเห็นชอบทุนวิจัย</h4>
              <div class="table-responsive">
                <table class="table table-striped table-bordered zero-configuration">
                  ...
                  <tbody>
                    <?php
                    $userId = $_SESSION["access-user"];
                    $path = "../formResearch/";
                    $department = $_SESSION["departmentName"];

                    $headDeptPath = "../headdept/".$userId.".json";
                    $jsonString = file_get_contents($headDeptPath);
                    ...
                    foreach ($files as $file) {
                      ...
                      if (checkHeadState($form['state'])) {
                        // && $form["state"] >= 0 && $form["state"] <= 3  && $form["statusAll"] == "รอหัวหน้าภาควิชาเห็นชอบ"
                        echo "<tr>";
                        ...
                        echo "<td style=\"text-align:center\"><a href=\"./detailhdept.php?formName=" . $form["formName"] . "\" type=\"submit\" class=\"btn btn-primary\"
