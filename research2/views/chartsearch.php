        ...
        <div class="col-md-10" style="display: block; justify-content: center; align-items: center;">
          <div class="card">
            <div class="card-body">
              <form action="chartsearch.php" method="post">
                <div class="form-group row">
                  <label class="col-lg-4 col-form-label" for="val-skill">ปีที่สืบค้น<span class="text-danger">*</span>
                  </label>
                  <div class="col-lg-3">
                    <select class="form-control" id="year" name="year" require>
                      ...
                      ?>
                        <option value="<?php echo $i?>" <?php if($i == $y){echo " selected";}?>><?php echo $i?></option>
                      <?php
                        }
                      ?>
                    </select>
                  ...
                  <div class="col-lg-3">
                  <button type="summit" class="btn mb-1 btn-primary">ค้นหา</button>
                  </div>
                </div>
              </form>
              <html>
              <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.5.0/Chart.min.js"></script>
              <h4 class="card-title">กราฟแสดงผลการเปรียบเทียบจำนวนเงินที่มีการขอทุนวิจัยต่อปีของทุนแต่ละประเภท ปี ค.ศ. <?php echo $_POST['year']; ?></h4>
              <html>
            ...
            <div class="card-body">
              ...
              <html>
              <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.5.0/Chart.min.js"></script>
              <h4 class="card-title">กราฟแสดงผลการเปรียบเทียบจำนวนเงินที่มีการขอทุนวิจัยต่อปีของแต่ละภาควิชา ปี ค.ศ. <?php echo $_POST['year']; ?></h4>
              <html>
              <div class="col-sm-6" style="width:100%;max-width:100%">

                <canvas id="learnyear2"></canvas>
              </div>
            </div>
            ...
            <div class="card-body">
              <html>
              <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.5.0/Chart.min.js"></script>
              <h4 class="card-title">กราฟจำนวนทุนที่มีการขอทุนวิจัยต่อภาควิชาของทุนแต่ละประเภท ปี ค.ศ. <?php echo $_POST['year']; ?></h4>
              <html>
              <div class="col-sm-6" style="width:100%;max-width:100%">
            ...
            <div class="card-body">
              <html>
              <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.5.0/Chart.min.js"></script>
              <h4 class="card-title">กราฟจำนวนทุนที่มีการขอทุนวิจัยต่อภาควิชาแต่ละสถานะของทุนอุดหนุนวิจัย ปี ค.ศ. <?php echo $_POST['year']; ?></h4>
              <html>
              <div class="col-sm-6" style="width:100%;max-width:100%">
            ...
            <div class="card-body">
              <html>
              <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.5.0/Chart.min.js"></script>
              <h4 class="card-title">กราฟจำนวนทุนที่มีการขอทุนวิจัยต่อภาควิชาแต่ละสถานะของทุนวิจัยนวัตกรรม ปี ค.ศ. <?php echo $_POST['year']; ?></h4>
              <html>
              <div class="col-sm-6" style="width:100%;max-width:100%">
...
foreach ($files as $file) {
    ...
    // Compare the year with the selected year range
    if ($selectedYear == $year) {
        // Update budget variables based on the form type
        if ($formData["type"] == "ทุนวิจัย") {
            $sumBudget["Research" . $year] += intval($formData["budget"]);
        } elseif ($formData["type"] == "ทุนนวัตกรรม") {
            $sumBudget["Innovative" . $year] += intval($formData["budget"]);
        }
...
<script>
    ...
    var ctx = document.getElementById("learnyear2");
    var myChart = new Chart(ctx, {
      type: 'bar',
      //type: 'line',
      data: {
